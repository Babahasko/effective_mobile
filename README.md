...
7. В задании довольно необычно представлен формат даты. Решил хранить в бд time.Time. А для запросов и ответов оставить представленный в задании - отсюда и расширение для валидатора.
